 ...
 * @param $quotes['nicolas-tesla']['text'] = the text of the quote
 */

$quotes['nicolas-tesla'] = array(
  array(
    "theme" => "brain",
    "text" => "L’instinct est quelque chose qui transcende la connaissance. Nous avons sans aucun doute, certaines fibres plus fines qui nous permettent de percevoir les vérités quand la déduction logique, ou tout autre effort volontaire du cerveau, est futile."
  ),
  array(
    "theme" => "be",
    "text" => "Laissons l’avenir dire la vérité, et évaluer chacun en fonction de son travail et de ses accomplissements. Le présent est à eux ; le futur, pour lequel j’ai réellement travaillé, est mien."
  ),
  array(
    "theme" => "physics",
  ...
  array(
    "theme" => "be",
    "text" => "Je pense qu’aucun frisson pouvant traverser le cœur d’un humain n’est comparable à ce que ressent un inventeur lorsqu’une création de son esprit se réalise avec succès. De telles émotions font oublier à un homme la nourriture, le sommeil, les amis, l’amour, tout."
  ),
  array(
    "theme" => "brain",
  ...
  array(
    "theme" => "be",
    "text" => "Tout le monde devrait considérer son corps comme un don inestimable de la part de l’Un, celui qui aime par-dessus tout, c’est une merveille artistique, d’une indescriptible beauté, et d’un mystère au-delà de toute conception humaine, si délicat qu’un simple mot, un souffle, un regard, que dis-je, une pensée peut lui nuire."
  ),
  array(
    "theme" => "be",
    "text" => "Nos vertus et nos défauts sont inséparables, comme la force et la matière. Lorsqu’ils sont séparés, l’être humain n’est plus."
  ),
  array(
    "theme" => "ignorance",
  ...
  array(
    "theme" => "brain",
    "text" => "L’invention est le plus important produit du cerveau créatif de l’humain. L’objectif ultime est la maîtrise complète de l’esprit sur le monde matériel, l’utilisation de la nature humaine pour les besoins humains."
  ),
  array(
    "theme" => "ignorance",
  ...
  array(
    "theme" => "intelligence",
    "text" => "Si seulement vous connaissiez la magnificence de 3, 6 et 9, alors vous auriez la clé de l’univers."
  ),
  array(
    "theme" => "religion",
    "text" => "Ce qu’un homme appelle Dieu, un autre l’appelle les lois de la physique."
  ),
  array(
    "theme" => "religion",
    "text" => "Le don de la force mentale vient de Dieu, Être Divin, et si l’on concentre son esprit sur cette vérité, nous devenons accordés (comme un instrument) avec ce grand pouvoir. Ma mère m’a appris à rechercher toute vérité dans la Bible."
  ),
  array(
    "theme" => "be",
    "text" => "Les grands moments naissent des grandes opportunités."
  ),
  array(
    "theme" => "religion",
  ...
  array(
    "theme" => "ignorance",
    "text" => "Un simple rayon de lumière d’une étoile lointaine arrivant aux yeux d’un tyran d’une époque révolue a peut-être changé le cours de sa vie, peut-être changé le destin des nations, ou peut avoir transformé la surface du globe. Si intriqués, si inconcevablement complexes sont les processus de la nature."
  ),
  array(
    "theme" => "ignorance",
    "text" => "En aucun cas nous ne pourrions obtenir une telle idée de la grandeur de la nature que lorsque l’on considère, conformément à la loi de la conservation de l’énergie dans l’Infini, les forces sont dans un équilibre parfait, et donc l’énergie d’une simple et unique pensée unique peut déterminer le mouvement d’un univers."
  ),
  array(
    "theme" => "be",
    "text" => "Dès l’enfance, j’ai été contraint à concentrer mon attention sur moi-même. Cela m’a causé beaucoup de souffrance, mais selon mon point de vue actuel, c’était une bénédiction déguisée qui m’a appris à apprécier la valeur inestimable de l’introspection dans la préservation de la vie, ainsi que comme moyen de réalisation."
  ),
  array(
    "theme" => "be",
    "text" => "La pression du travail et le flux incessant des idées se déversant dans notre conscience à travers toutes les portes de la connaissance rendent l’existence moderne risquée à bien des égards."
  ),
  array(
    "theme" => "be",
